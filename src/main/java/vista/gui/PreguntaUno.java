...
/*
 * esta clase se encargara de crear y ejecutar la ventana de la primer pregunta**/

public class PreguntaUno extends JFrame implements ActionListener{
	...
	public void iniciarComponentes(){
		...
		lblPregunta.setText("1. Dirige al Pacman a su Cereza");
		...
		ImageIcon image = new ImageIcon(PreguntaUno.class.getResource("/images/nivel1.png"));
		Icon icon = new ImageIcon(image.getImage().getScaledInstance(lblImagen.getWidth(), lblImagen.getHeight(), 6));
		
		
		pacman = new JLabel();
		pacman.setLocation(140, 330);
		...
		pacmanInicial.setLocation(154, 347);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==btnSubir) {			
			...
			miCoordinador.mostrarPregunta2(miRespuesta);
		}
	}
	...
	public void validacion(int x, int y) {
		...
		if(x==330) {
			...
			if(y==78) {
				...
				this.miRespuesta.setPreguntaUno(2);
				...
				this.txtValidacion.setVisible(true);
				this.miRespuesta.setPreguntaUno(1);
				this.pacman.setVisible(true);
			}
	...
	public void reiniciarNivel() {
		...
		scrollPane.setVisible(false);
		pacman.setVisible(false);
		txtValidacion.setVisible(false);
		cambiarDificultad2();
