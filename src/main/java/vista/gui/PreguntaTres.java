...
/*
 * esta clase se encargara de crear y ejecutar la ventana de la tercera pregunta**/
public class PreguntaTres extends JFrame implements ActionListener{
	...
	public void iniciarComponentes(){
		...
		lblPregunta.setText("3. Dirige al Pacman a su Cereza");
		...
		ImageIcon image = new ImageIcon(PreguntaUno.class.getResource("/images/nivel3.png"));
		Icon icon = new ImageIcon(image.getImage().getScaledInstance(lblImagen.getWidth(), lblImagen.getHeight(), 6));
		
		
		pacman = new JLabel();
		pacman.setLocation(394, 15);
		...
		pacmanInicial.setLocation(409, 31);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==btnSubir) {			
			...
			miCoordinador.mostrarPregunta4(miRespuesta);
		}
	}
	...
	public void validacion(int x, int y) {
		if(x==140) {
			...
			if(y==458) {
				...
				this.miRespuesta.setPreguntaTres(2);
				...
				this.txtValidacion.setVisible(true);
				this.miRespuesta.setPreguntaTres(1);
				this.pacman.setVisible(true);
			}
