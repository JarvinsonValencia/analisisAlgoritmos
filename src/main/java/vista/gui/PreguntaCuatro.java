...
/*
 * esta clase se encargara de crear y ejecutar la ventana de la cuarta pregunta**/

public class PreguntaCuatro extends JFrame implements ActionListener{
	...
	public void iniciarComponentes(){
		...
		lblPregunta.setText("4. Dirige al Pacman a su Cereza");
		...
		ImageIcon image = new ImageIcon(PreguntaUno.class.getResource("/images/nivel4.png"));
		Icon icon = new ImageIcon(image.getImage().getScaledInstance(lblImagen.getWidth(), lblImagen.getHeight(), 6));
		
		
		pacman = new JLabel();
		pacman.setLocation(13, 15);
		...
		pacmanInicial.setLocation(30, 30);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==btnSubir) {			
			...
			miCoordinador.mostrarPregunta5(miRespuesta);
		}
	}
	...
	public void validacion(int x, int y) {
		if(x==330) {
			...
			if(y==330) {
				...
				this.miRespuesta.setPreguntaCuatro(2);
				...
				this.txtValidacion.setVisible(true);
				this.miRespuesta.setPreguntaCuatro(1);
				this.pacman.setVisible(true);
			}
