...
/*
 * esta clase se encargara de crear y ejecutar la ventana de la segunda pregunta**/
...
public class PreguntaDos extends JFrame implements ActionListener{
	...
	public void iniciarComponentes(){
		...
		lblPregunta.setText("2. Dirige al Pacman a su Cereza");
		...
		ImageIcon image = new ImageIcon(PreguntaUno.class.getResource("/images/nivel2.png"));
		Icon icon = new ImageIcon(image.getImage().getScaledInstance(lblImagen.getWidth(), lblImagen.getHeight(), 6));
		
		
		pacman = new JLabel();
		pacman.setLocation(140, 458);
		...
		pacmanInicial.setLocation(155, 471);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==btnSubir) {			
			...
			miCoordinador.mostrarPregunta3(miRespuesta);
		}
	}
	...
	public void validacion(int x, int y) {
		if(x==13) {
			...
			if(y==15) {
				...
				this.miRespuesta.setPreguntaDos(2);
				...
				this.txtValidacion.setVisible(true);
				this.miRespuesta.setPreguntaDos(1);
				this.pacman.setVisible(true);
			}
